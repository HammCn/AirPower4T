...
export class AirValidator {
  ...
  static isChineseIdCard(str: string): boolean {
    ...
    if (str.length === 15) {
      // 15位省份证校验
      if (/^[1-9]\d{5}((\d{2}(((0[13578]|1[02])(0[1-9]|[12][0-9]|3[01]))|((0[13456789]|1[012])(0[1-9]|[12][0-9]|30))|(02(0[1-9]|1[0-9]|2[0-8]))))|(((0[48]|[2468][048]|[13579][26])|(00))0229))\d{2}[0-9Xx]$/.test(str)) {
        return true
      }
      return false
    }
